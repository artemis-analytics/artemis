...
class CsvGenMenu(MenuBuilder):
    ...
    def _algo_builder(self):
        ...
        """
        self._algos["testalgo"] = DummyAlgo1(
            "dummy", myproperty="ptest", loglevel="INFO"
        )
    ...
    def _seq_builder(self):
        self._seqs["seq1"] = Node(["initial"], ("dummy", "dummy"), "seq1")
        self._seqs["seq2"] = Node(["initial"], ("dummy", "dummy"), "seq2")
        self._seqs["seq3"] = Node(["seq1", "seq2"], ("dummy",), "seq3")
        self._seqs["seq4"] = Node(["seq3"], ("dummy",), "seq4")

        self._seqs["seq5"] = Node(["initial"], ("dummy", "dummy"), "seq5")
        self._seqs["seq6"] = Node(["seq5"], ("dummy", "dummy"), "seq6")
        self._seqs["seq7"] = Node(["seq6"], ("dummy",), "seq7")

        self._seqs["seqX"] = Node(["initial"], ("csvparser",), "seqX")
        self._seqs["seqY"] = Node(["seqX"], ("profiler",), "seqY")
