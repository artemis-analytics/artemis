...
class JobConfigFactory:
    def __new__(cls, config, menu=None, **kwargs):
        ...
        if config == "csvgen":
            ...
            from artemis.configurables.configs.legacygenconfig import LegacyGenConfig

            return LegacyGenConfig(menu, **kwargs)
        elif config == "legacyio":
            from artemis.configurables.configs.legacygenconfig import LegacyIOConfig
