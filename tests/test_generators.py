...
class GeneratorTestCase(unittest.TestCase):
    ...
    def test_write_mixed_csv(self):
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            generator = GenCsvLikeArrow(
                "generator", nbatches=4, table_id=tbl_id, num_rwows=10000
            )
            generator.gate.meta.parentset_id = ds_id
            generator.gate.meta.job_id = str(job_id)
            generator.gate.store = store
    ...
    def test_continuous_write(self):
        ...
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            generator = GenCsvLikeArrow(
                "test", nbatches=4, num_rows=10000, table_id=id_
            )
    ...
    def test_filegenerator(self):
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            generator = GenCsvLikeArrow("test", nbatches=3, file_type=1, table_id=id_)
    ...
    def test_iter_csv(self):
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            generator = GenCsvLikeArrow(
                "generator", nbatches=4, table_id=tbl_id, num_rows=10000
            )
            generator.gate.meta.parentset_id = ds_id
            generator.gate.meta.job_id = str(job_id)
            generator.gate.store = store
