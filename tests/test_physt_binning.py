...
from artemis.externals.physt import binnings
import numpy as np
import unittest
...
class TestCalculateBinsNd(unittest.TestCase):
...
class TestFixedWidthBins(unittest.TestCase):
...
class TestHumanBinsi(unittest.TestCase):
...
class TestIntegerBins(unittest.TestCase):
...
class TestExponentialBins(unittest.TestCase):
