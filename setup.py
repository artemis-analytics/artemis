...
def main():
    ...
    make_ext(
        "artemis.externals.accumulation_tree.accumulation_tree",
        sources="./artemis/externals/accumulation_tree/accumulation_tree.pyx",
    )
...
def link_arrow(ext):
    ...
    ext.include_dirs.append(
        np.get_include()
    )  # Arrow is working on removing this dependency
